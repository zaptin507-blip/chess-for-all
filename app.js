    ...
    async initStockfish() {
        ...
        if (window.NNUE_SUPPORTED && typeof window.Stockfish === 'function') {
            ...
            try {
                ...
                console.log(`✅ NNUE Stockfish initialized (Threads=${numThreads}, Hash=${hashMB}MB, Overhead=10ms, Contempt=${this.contemptValue})`);
                return engine;
            } catch (error) {
    ...
    async initAnalysisEngine() {
        ...
        if (window.NNUE_SUPPORTED && typeof window.Stockfish === 'function') {
            ...
            try {
                ...
                console.log(`✅ NNUE analysis engine initialized (Threads=${numThreads}, Hash=${hashMB}MB, Overhead=10ms)`);
                return engine;
            } catch (error) {
