const chessOpenings = {
    ...
    petrov: {
        ...
        mainIdea: 'Mirror white\'s Nf3 with ...Nf6, creating a symmetrical position. The first player to deviate often ends up worse — aim for early equality.',
    ...
    philidor: {
        ...
        mainIdea: 'Support e5 with ...d6 instead of ...Nc6, keeping options open. Solid but passive — prioritize safety and look for ...d5 breaks.',
    ...
    kingsGambit: {
        ...
        mainIdea: 'Sacrifice the f-pawn to open lines toward the black king. Aim for rapid development and a devastating attack before black can consolidate.',
    ...
    scandinavian: {
        ...
        mainIdea: 'Challenge white\'s center immediately with ...d5. The queen comes out early but gains time by retreating while white develops.',
    ...
    danishGambit: {
        ...
        mainIdea: 'Sacrifice one or two pawns for a massive lead in development. Open the center completely and target f7 with bishops and knights.',
    ...
    bishopsOpening: {
        ...
        mainIdea: 'Develop the bishop to c4 early, keeping d4 and f4 options open. Flexible and underrated — can transpose to Italian or Vienna structures.',
    ...
    ponziani: {
        ...
        mainIdea: 'Play c3 early to prepare d4 while keeping the Qa4 pin option. An old opening with tricky traps for unprepared opponents.',
    ...
    centerGame: {
        ...
        mainIdea: 'Bring the queen out early to dominate the center after d4 exd4. Leads to open, tactical positions with the exposed queen as a target.',
    ...
    catalan: {
        ...
        mainIdea: 'Fianchetto the king\'s bishop to exert long-term pressure on black\'s position. Combine a strong center with queenside space advantage.',
    ...
    semiSlav: {
        ...
        mainIdea: 'Combine the solidity of the Slav with the flexibility of the Orthodox Defense. Fight for control of e4 while maintaining a rock-solid structure.',
    ...
    queensIndian: {
        ...
        mainIdea: 'Fianchetto the light-squared bishop to control the long diagonal. The Queen\'s Indian is solid and flexible, neutralizing white\'s space advantage.',
    ...
    trompowsky: {
        ...
        mainIdea: 'Develop the bishop to g5 early, disrupting black\'s plans. The Trompowsky avoids main theory and creates imbalanced, tactical positions.',
    ...
    reti: {
        ...
        mainIdea: 'Control the center with pieces rather than pawns. Fianchetto the king\'s bishop and strike later with d4 or e4 breaks.',
    ...
    benkoGambit: {
        ...
        mainIdea: 'Sacrifice a pawn on b5 to open the a- and b-files for long-term queenside pressure. The initiative and open lines compensate for the material deficit.',
    ...
    evansGambit: {
        ...
        mainIdea: 'Sacrifice the b4 pawn to build a powerful center and open attacking lines. A romantic-era favorite with devastating attacking potential.',
    ...
    marshallAttack: {
        ...
        mainIdea: 'Sacrifice a pawn on d5 for a permanent kingside attack. Black gets unrelenting pressure against white\'s king with open files and active pieces.',
    ...
    modernDefense: {
        ...
        mainIdea: 'Fianchetto the king\'s bishop and allow white to occupy the center, then strike back with ...d5 or ...e5. Flexible and hypermodern.',
    ...
    budapestGambit: {
        ...
        mainIdea: 'Sacrifice a pawn on e5 for rapid development and active piece play. Strike back in the center immediately with ...e5.',
    ...
    twoKnightsDefense: {
        ...
        mainIdea: 'Develop the knight to f6 against the Italian Game, inviting sharp tactical play. Both sides have attacking chances in this aggressive response.',
    ...
    queensGambitDeclined: {
        ...
        mainIdea: 'Support d5 with e6, building a solid pawn chain. The Queen\'s Gambit Declined is the most classical defense — solid, reliable, and rich in strategy.',
    ...
    queensGambitAccepted: {
        ...
        mainIdea: 'Accept the gambit pawn and hold it temporarily, then return it at the right moment for a comfortable position. Leads to open, active play.',
    ...
    colleSystem: {
        ...
        mainIdea: 'Build a solid system with d4, e3, and Nf3, then launch a kingside attack with the famous \'Colle Zukertort\' setup. Reliable and easy to learn.',
    ...
    scotchGambit: {
        ...
        mainIdea: 'Sacrifice a pawn in the Scotch for rapid development and attacking chances against black\'s exposed king. Sharp and aggressive.',
    ...
    dragonSicilian: {
        ...
        mainIdea: 'Fianchetto the king\'s bishop on g7 to control the long diagonal, then launch a ferocious kingside attack. One of the sharpest Sicilian lines.',
    ...
    scheveningen: {
        ...
        mainIdea: 'Build a small center with e6 and d6, then counter-attack on the queenside. The Scheveningen is flexible and rich in counterplay.',
    ...
    sveshnikov: {
        ...
        mainIdea: 'Create sharp imbalances with an early ...e5 in the Sicilian. Accept a backward d-pawn for active piece play and dynamic counterattacks.',
    ...
    taimanov: {
        ...
        mainIdea: 'Develop with ...e6 and ...Nc6 without committing the king\'s bishop. The Taimanov is flexible, positional, and avoids sharpest Sicilian lines.',
    ...
    kingsIndianAttack: {
        ...
        mainIdea: 'Fianchetto the king\'s bishop and build a flexible setup against any black defense. The King\'s Indian Attack is a universal system with solid attacking plans.',
    ...
    hedgehog: {
        ...
        mainIdea: 'Build a flexible, resilient pawn structure with black pieces. Absorb white\'s space advantage and counter-attack at the right moment.',
    ...
    larsen: {
        ...
        mainIdea: 'Fianchetto the queen\'s bishop immediately, controlling the long diagonal. Unusual and tricky — aim for an early e4 break or transpose to a King\'s Indian Attack.',
    ...
    albinCounter: {
        ...
        mainIdea: 'Create an unbalanced position with the Albin Counter-Gambit. Accept structural weaknesses for active piece play and tactical chances.',
    ...
    chigorin: {
        ...
        mainIdea: 'Develop the queen\'s knight to c6 instead of the usual ...d5 defense. Unorthodox development creates imbalances and tactical opportunities.',
    ...
    acceleratedDragon: {
        ...
        mainIdea: 'Fianchetto the king\'s bishop on g7 to control the long diagonal. One of the sharpest Sicilian lines — both sides attack on opposite wings with pawn storms.',
    ...
    kanSicilian: {
        ...
        mainIdea: 'Develop with ...a6 and ...b5 to gain space on the queenside. The most flexible Sicilian — adapt your setup based on white\'s response.',
    ...
    bogoIndian: {
        ...
        mainIdea: 'Check on b4 to disrupt white\'s plans without committing to a full Nimzo setup. Flexible transposition options to other Indian defenses.',
    ...
    smithMorraGambit: {
        ...
        mainIdea: 'Sacrifice a pawn with c3 to seize the center, then develop rapidly with Nf3 and Bc4. Open lines toward the black king at all costs.',
            ...
            if (char >= '1' && char <= '8') {
                ...
                if (pieceSVG && pieceSVG[pieceKey]) {
                    ...
                    if (pieceStyle === 'neo') {
                        ...
                        if (pieceKey.startsWith('w')) {
                            svgStr = svgStr.replace(/fill="#fff"/g, 'fill="#eae4dc"');
                            svgStr = svgStr.replace(/stroke="#000"/g, 'stroke="#6b1010"');
                        } else {
                            svgStr = svgStr.replace(/fill="#000"/g, 'fill="#030303"');
                            svgStr = svgStr.replace(/stroke="#000"/g, 'stroke="#8b0000"');
                            svgStr = svgStr.replace(/stroke="#ececec"/g, 'stroke="#dd2222"');
                        }
                    }
